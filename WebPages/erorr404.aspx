<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="erorr404.aspx.cs" Inherits="WebPages.erorr404" %>
    ...
    <form id="form1" runat="server">
        <div class="row">
            <div class="mian col-sm-12 col-xs-12">
                ...
                <h4>ممکن است این صفحه حذف یا منتقل شده باشد یا </h4>

                <h4>با آدرس اشتباه وارد شده باشید </h4>
