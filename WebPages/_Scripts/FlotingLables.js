////////////
////   note: Add External JavaScript - Default jquery libs
////    https://cdnjs.cloudflare.com/ajax/libs/jquery/3.1.0/jquery.min.js
////////////

/*** Assign a class for placeholder lable js ***/
$(document).ready(function () {
    $('.FloatingLabel').placeholderLabel();
})

/*** Placeholder Label js ***/
(function ($) {
    $.fn.placeholderLabel = function (options) {
        ...
        $(this).each(function (i, e) {
            ...
            if (self.attr('placeholder')) {
                ...
                label.css('margin-right', (Number(pl.replace('px', '')) - 5) + Number(ml.replace('px', '')));
