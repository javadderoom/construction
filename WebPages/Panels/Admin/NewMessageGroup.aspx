<%@ Page Title="" Language="C#" MasterPageFile="~/Panels/Admin/NewAdminMaster.Master" AutoEventWireup="true" CodeBehind="NewMessageGroup.aspx.cs" Inherits="WebPages.Panels.Admin.NewMessageGroup" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Content" runat="server">
    <div class="c-title">
        <h4>
            ...
            <asp:Literal runat="server" Text="ارسال پیام گروهی" /></h4>
    </div>
