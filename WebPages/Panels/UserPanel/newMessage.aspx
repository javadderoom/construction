    ...
    <div class="bigDiv">
        <div class="c-title">
            <h3>
                ...
                <asp:Literal runat="server" Text="پیام جدید" /></h3>
        </div>
                    ...
                    <div class="x_panel">
                        ...
                        <div class="x_content">
                            <div id="demo-form2" class="form-horizontal form-label-right">
                                <div class="col-md-8 col-md-offset-2 col-xs-12 " style="float: right;">
                                            ...
                                            <div class="form-group">
                                                <div class="row">
                                                    ...
                                                    <div class="col-xs-12 col-sm-10 col-sm-pull-2 text-right dirRight">
                                                        <div class="alert alert-warning alert-dismissible text-right dirRight" style="background-color: #18bc9c;" role="alert">
